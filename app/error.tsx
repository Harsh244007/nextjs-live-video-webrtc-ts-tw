...
const Navigation = lazy(() => import("@/app/components/Header/Header"));
...
const Error: React.FC = () => {
  return (
    <section className="flex flex-col items-center justify-center h-screen">
      ...
      <Link href={"/"}>
        <button className={`bg-indigo-500 text-white py-2 px-4 rounded hover:bg-indigo-600 m-auto mt-4 `}>Home</button>
      </Link>
    </section>
  );
};
